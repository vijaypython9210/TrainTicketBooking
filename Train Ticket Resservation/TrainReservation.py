...
class TrainRerservation:
    tickets={}
    lower,lTotalSize,lCurrentSize=[],1,0
    upper,uTotalSize,uCurrentSize=[],1,0
    rac,racTotalSize,racCurrentSize=[],1,0
    wl,wlTotalSize,wlCurrentSize=[],1,0
    ...
    def deleteTickets(self,seatNo,berth):
        if berth=='L':
    ...
    def showSeatAvailabilities(self):
        ...
        if choice==1:
            ...
            while(True):
                ...
                if seat=='L' or seat=='U' or seat=='RAC' or seat=='WL':
                    break
            tr.deleteTickets(id,seat)
        elif choice==3:
            res=tr.showSeatAvailabilities()
        elif choice==4:
            tr.displayAllDetails()
        elif choice==5:
            break
        else:
            print('Please a valid options')
